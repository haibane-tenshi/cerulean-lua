    ...
    Ty: Types,
{
    ...
    ImmutableCache(ImmutableCacheError),
    ...
    Ty: Types,
{
    pub fn into_diagnostic(self, heap: &Heap<Ty>, chunk_cache: &dyn ChunkCache) -> Diagnostic {
        ...
        let message = match self {
            ...
            RuntimeError::ImmutableCache(err) => err.into_diagnostic(),
    ...
    Ty: Types,
{
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::ImmutableCache(arg0) => f.debug_tuple("Immutable").field(arg0).finish(),
    ...
    Ty: Types,
{
    fn clone(&self) -> Self {
        match self {
            ...
            Self::ImmutableCache(arg0) => Self::ImmutableCache(arg0.clone()),
