...
use crate::value::{
    Key, Meta, SolitaryType, StrongCallable, StrongValue, Types, Value, WeakKey, WeakValue,
};
    ...
    Ty: Types,
{
    ...
    fn lookup_event(&self, event: Event) -> WeakKey<Ty> {
        use crate::gc::LuaPtr;
    ...
    Ty: Types,
{
    ...
    pub fn new_thread(&mut self, callable: StrongCallable<Ty>) -> ThreadId {
